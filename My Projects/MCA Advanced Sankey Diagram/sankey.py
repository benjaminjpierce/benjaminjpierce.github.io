...
Authors: John Rachlin and Benjamin Pierce
Date: 10/1/23
"""
...
def generate_and_show_sankey(data, group_columns, filter_criteria=None, threshold=None, title=None):
    """
    ...
    sankey_diagram = make_sankey(filtered_data, *group_columns, vals='count', title=title)
    sankey_diagram.show()
